/** Machine translation engines that suffer from PDF line-break noise. */
export const MACHINE_TRANSLATE_ENGINE_IDS = Object.freeze([
    "google",
    "bing",
    "deepl",
    "deeplx",
 ...
 */
export function isMachineTranslateEngine(engineId) {
 ...
 */
export function isPdfViewerPage(pathname = "") {
    const path =
        pathname ||
 ...
 */
export function isSelectionFromPdfTextLayer(selection) {
    try {
        const sel =
            selection ||
 ...
 * @param {Selection | null | undefined} [selection]
 */
export function isPdfSelectionContext(selection) {
...
/**
 * Merges PDF text-layer line breaks inside paragraphs while keeping blank-line gaps.
 * @param {string} text
 */
